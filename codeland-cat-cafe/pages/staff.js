...
function Staff() {
  return (
    <Layout route={"staff"} title={"Staff"}>
      <Grid>
        <Card
          name={"Emily Giurleo"}
          image={
        ...
        >
          My name is Emily Giurleo, and I'm the leader of this workshop! I love software and cats, and I'm so excited to share this workshop with you!
        </Card>
      </Grid>
    </Layout>
  );
